...
class DropSubject extends CI_Controller {
    
    function __construct() {
        parent::__construct();
		$this->load->model("ServiceApplications/DropSubjectModel", "m");
    }
    
    
    public function index() {
        echo "You are at: api/<b>serviceapplications</b>/<b>dropsubject</b>/index";
    }
